            ...
            {staffingCategories.map((category, index) => (
              ...
              >
                ...
                <div className="p-8">
                  ...
                  {/* CTA */}
                  <button className="mt-10 w-full rounded-xl border border-gray-300 px-6 py-3 text-sm font-semibold text-gray-700 hover:border-[#3f7ec1] hover:text-[#3f7ec1] hover:bg-[#3f7ec1]/10 transition-all duration-300">
          ...
          <div className="mt-20 pt-20 border-t border-gray-200">
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-8 shadow-xl">
                ...
                <button className="w-full bg-gradient-to-r from-[#96bb57] via-[#3f7ec1] to-[#0A4C8A] text-white px-8 py-4 rounded-xl font-semibold hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 flex items-center justify-center gap-3">
      ...
      <section className="py-20 md:py-32 bg-gradient-to-r from-[#96bb57] via-[#3f7ec1] to-[#0A4C8A] text-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/95 max-w-2xl mx-auto mb-12 leading-relaxed">
            Connect with our staffing experts to find the perfect talent for your organization and accelerate your growth journey.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-white text-[#05325A] px-8 py-4 rounded-xl font-semibold hover:bg-gray-50 hover:shadow-2xl transition-all duration-300 inline-flex items-center justify-center gap-3 shadow-lg">
              Schedule Staffing Consultation
          ...
          <div className="mt-16 pt-16 border-t border-white/20">
            <div className="flex flex-col md:flex-row items-center justify-center gap-8 text-white/90">
              <div className="flex items-center gap-3">
                ...
                <span>staffing@infogrowth.com</span>
              </div>
              <div className="hidden md:block w-px h-6 bg-white/30"></div>
              <div className="flex items-center gap-3">
                <HeadphonesIcon className="w-5 h-5" />
                <span>24/7 Staffing Support</span>
              </div>
              <div className="hidden md:block w-px h-6 bg-white/30"></div>
              <div className="flex items-center gap-3">
                <Clock className="w-5 h-5" />
