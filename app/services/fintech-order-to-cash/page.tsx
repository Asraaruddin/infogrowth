...
export default function FintechOrderToCashPage() {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <button className="w-full md:w-auto bg-gradient-to-r from-[#96bb57] to-[#3f7ec1] text-white px-8 py-4 rounded-xl font-semibold hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 flex items-center justify-center gap-3">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="bg-gradient-to-r from-[#96bb57] to-[#3f7ec1] rounded-2xl p-8 text-white">
              ...
              <button className="w-full bg-white text-[#05325A] px-8 py-4 rounded-xl font-semibold hover:bg-gray-50 hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-3">
      ...
      <section className="py-20 md:py-32 bg-gradient-to-r from-[#96bb57] via-[#3f7ec1] to-[#0A4C8A] text-white">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/95 max-w-2xl mx-auto mb-12 leading-relaxed">
            Join hundreds of enterprises that have optimized their Order to Cash processes with our FinTech platform. 
  ...
  <select
    ...
    className="
      ...
      text-gray-900
      focus:border-[#3f7ec1]
      focus:ring-2 focus:ring-[#3f7ec1]/20
      outline-none
      transition-all
      cursor-pointer
    "
  >
    ...
    <option value="s4hana" className="text-gray-900">
    Under $100
    </option>
    <option value="b1" className="text-gray-900">
     $100K - $500K
    </option>
    <option value="btp" className="text-gray-900">
     $500K - $1M
    </option>
    <option value="sac" className="text-gray-900">
     $1M - $5M
    </option>
    <option value="successfactors" className="text-gray-900">
     $5M - $10M
    </option>
    <option value="eppm" className="text-gray-900">
$10M+
    </option>
  </select>
</div>
          ...
          <div className="mt-16 pt-16 border-t border-white/20">
            <div className="flex flex-col md:flex-row items-center justify-center gap-8 text-white/90">
              <div className="flex items-center gap-3">
                ...
                <span>fintech@infogrowth.com</span>
              </div>
              <div className="hidden md:block w-px h-6 bg-white/30"></div>
              <div className="flex items-center gap-3">
                <HeadphonesIcon className="w-5 h-5" />
                <span>24/7 Financial Operations Support</span>
              </div>
              <div className="hidden md:block w-px h-6 bg-white/30"></div>
              <div className="flex items-center gap-3">
                <Clock className="w-5 h-5" />
