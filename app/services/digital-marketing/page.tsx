...
export default function DigitalMarketingPage() {
  ...
  const clients = [
    { name: "RockAutoCare", industry: "Automotive Parts", region: "USA/UK" },
    { name: "E-Shop Pro", industry: "E-commerce", region: "USA" },
    { name: "StyleHub", industry: "Fashion Retail", region: "UK" },
    { name: "TechGadgets", industry: "Electronics", region: "USA/UK" },
  ];
      ...
      <section className="py-20 md:py-32 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              We partner with businesses across various sectors to drive digital success
            </p>
          </div>
      ...
      <section className="py-20 md:py-32 bg-gradient-to-r from-[#96bb57] via-[#3f7ec1] to-[#0A4C8A] text-white">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-8">
            Contact us right now to get your personalized digital marketing proposal
          </h2>
          
          <p className="text-xl text-white/95 max-w-2xl mx-auto mb-12 leading-relaxed">
            Complete with strategy, pricing, and a clear success path tailored to your business goals.
          </p>
          ...
          <div className="mt-16 pt-16 border-t border-white/20">
            <div className="flex flex-col md:flex-row items-center justify-center gap-8 text-white/90">
              <div className="flex items-center gap-3">
                ...
                <span>marketing@infogrowth.com</span>
              </div>
