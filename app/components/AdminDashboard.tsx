...
//               </div>
//               <Mail className="w-6 h-6 sm:w-8 sm:h-8 opacity-80" />
//             </div>
//           </div>

//           <div className="bg-gradient-to-br from-yellow-500 to-orange-500 rounded-xl p-4 sm:p-6 text-white">
//             <div className="flex items-center justify-between">
//               <div>
//                 <div className="text-xl sm:text-2xl font-bold">{stats.new}</div>
//                 <div className="text-xs sm:text-sm opacity-90">New</div>
//               </div>
...
//             <div className="flex items-center justify-between">
//               <div>
//                 <div className="text-xl sm:text-2xl font-bold">{stats.read}</div>
//                 <div className="text-xs sm:text-sm opacity-90">Read</div>
//               </div>
...
//             <div className="flex items-center justify-between">
//               <div>
//                 <div className="text-xl sm:text-2xl font-bold">{stats.replied}</div>
//                 <div className="text-xs sm:text-sm opacity-90">Replied</div>
//               </div>
